...
?>
											...
											<tr>												
												...
												<td><?php echo $row->existencia*$row->prod_costopromedio;?></td>
										 ...
										 <tfoot>
           <tr>
    <th colspan="9">Total Inventario</th>
    <td colspan="2" style="font-size: 20px; text-align: right; font-weight: bold;"><?php echo "$ " . number_format($sumatotal, 2, '.', ',');?></td>
	<td></td>
</tr>
...
<script>
    ...
    function setFormAction() {
        ...
        if (selectedOption == 1) {
    document.forms['marcas'].action = 'inventario_excel.php';
