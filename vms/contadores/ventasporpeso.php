...
<body>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Detalle de Ventas por Peso</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                                    <span></span>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="panel panel-white">
                                            <div class="panel-heading">
                                                <h5 class="over-title margin-bottom-15"><span class="text-bold">Ventas por Peso</span></h5>
                                                ...
                                                <div class="form-group">
															...
															<select name="proveedor" id="proveedor" live-search="true">
															<?php 
    ...
    <script>
        function setFormAction() {
            ...
            if (selectedOption == 1) {
                document.forms['marcas'].action = 'detalle_ventas_peso_excel.php';
