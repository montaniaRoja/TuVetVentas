                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <table id="example" class="display" style="width:100%">
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="8">Total Ventas</td>
                                            <td colspan="2" style="text-align: right; font-weight: bold;"><?php echo "Costo $ " . number_format($costototal, 2, '.', ','); ?></td>
                                            <td colspan="2" style="text-align: right; font-weight: bold;"><?php echo "Venta sin Iva $ " . number_format($total/1.13, 2, '.', ','); ?></td>
                                            <td colspan="2" style="text-align: right; font-weight: bold;"><?php echo "Venta Total $ " . number_format($total, 2, '.', ','); ?></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
