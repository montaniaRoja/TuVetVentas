...
<html lang="en">
	<head>
		<title>Admin | Reporte Compras Desglosadas</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Reporte Compras Desglosadas</h1>
								</div>
									<ol class="breadcrumb">
										<li>
										...
										<li class="active">
											<span>Reporte Compras Desglosadas</span>
										</li>
									</ol>
							</div>
						</section>
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
												...
												<div class="panel-body">
													...
													<form role="form" method="post" >
                                                        ...
                                                        <div class="form-group">
															...
															<div class="input-group" style="width: 100%">
																<select name="proveedor" id="proveedor" style="width: 100%" class="form-control" data-live-search="true" multiple>
																<?php 
																$query2="SELECT id,prov_nombre FROM proveedores order by prov_nombre";
																$consulta=pg_query($db,$query2);
																while($obj1=pg_fetch_object($consulta)){?>
																	<option value="<?php echo $obj1->id ?>"<?php if($obj1->prov_nombre=='seleccione categoria'){echo "selected";}?>><?php echo $obj1->prov_nombre;?></option>
																
																<?php }?>
																</select>
																<input type="checkbox" id="checkbox_prov" >Seleccionar Todos
															</div>
															<noti_prov style="color:red"></noti_prov>
														</div>
                                                        <div class="form-group">
															<label for="inputData">
																Categorias
														...
														<a type="buttom" id="buscar" name="buscar" class="btn btn-o btn-primary" onClick="buscarComprasDesglosadas()">
															Procesar
														</a>
													</form>
												</div>
									...
									<div class="row">
										<div class="col-md-12">										
											<table id="tabla_compras" class="display" style="width:100%">	
												<thead>
													<tr>
														<th>Factura</th>
														<th>Producto</th>
