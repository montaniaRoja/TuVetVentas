...
if (isset($_POST['submit'])) { //if del submit
    ...
    $query = ("INSERT INTO productos(id,prod_codbarra, prod_nombre,id_marca,id_categorias,
                                    ...
                                    prod_univenta,prod_preciopublico,prod_costopromedio,descuento_unidad,
                                    escalas,prod_ultimocosto,sucursal_crea,porcentaje_impuesto,
                                    codigo_impuesto,bodegasn)
    ...
    $params = array(
        ...
        $sumainv, $activo, $minimoVenta, $precio, $costo, $descUnidad, $escala, $ultimoCosto, $sucursalCrea, $porcimpuesto, $impuestos, $bodega
    );
