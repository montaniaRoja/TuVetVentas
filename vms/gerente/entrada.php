...
join sucursales s on e.sucursal_id=s.id where e.estado='Pendiente' and e.sucursal_id='$sucursal';");
$cnt=1;
...
?>
											...
											<tr>
                    							...
                    							<form action="procesarentrada.php" method="GET">
                        						...
                        						<button type="submit" class="btn btn-transparent btn-xs" data-toggle="tooltip" data-placement="top" title="Edit" disabled>
                          						Autorizar
                        						</button>
                    							</form>
												</div>
