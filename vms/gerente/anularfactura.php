...
<body>
														...
														<div class="modal-content">
															...
															<div class="modal-body">
																<form method="post" name="submit" action="procesaranulacion.php">
																	...
																	<button type="submit" name="anular" id="anular" class="btn btn-primary" onclick="return confirmacion()">Procesar Devolucion</button>
																</form>
	...
	<script>
		function confirmacion() {
			return confirm("¿Estás seguro de que deseas procesar esta devolución?");
		}
	</script>
