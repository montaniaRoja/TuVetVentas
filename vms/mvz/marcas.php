...
if(isset($_POST['submit']))
{
    ...
    $nombreMarca=$_REQUEST['nuevamarca'];
    $paisOrigen=$_REQUEST['pais'];
    $nombreProveedor=$_REQUEST['proveedor'];
    ...
    $params = array($nombreMarca,$paisOrigen,$nombreProveedor,$usuarioCrea,$fecha_actual,$activo,$sucursalCrea);
