...
if(isset($_POST['marca']))
{
    ...
    $aplicarDescuento = pg_query($db, "UPDATE productos SET prod_porcdescuento='$porcDescuento', 
                                        modificada_por='$modifica',
                                        descuento_unidad=prod_preciopublico*$porcDescuento, 
                                        fecha_modificacion=to_date('$fecha_actual','dd/mm/yy')
...
if(isset($_POST['ambos']))
{
    ...
    $aplicarDescuento = pg_query($db, "UPDATE productos SET prod_porcdescuento='$porcDescuento',
                                        ...
                                        descuento_unidad=prod_preciopublico*$porcDescuento,
                                        fecha_modificacion=to_date('$fecha_actual','dd/mm/yy')
                                        WHERE id_categorias=$idCategorias and id_marca='$idMarca'");
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
													<form role="form" name="marcas" method="post" >
														...
														<div class="form-group">
															...
															<select name="selectmarca" id="marca">
															<?php 
    														...
    														<option value="<?php echo $obj1->id ?>"<?php if($obj1->marca_nombre=='Seleccione marca'){echo "selected";}?>><?php echo $obj1->marca_nombre;?></option>
														...
														<div class="form-group">
															...
															<select name="selectcategoria" id="categoria">
															<?php 
    														...
    														<option value="<?php echo $obj1->id ?>"<?php if($obj1->prov_nombre=='Seleccione Categoria'){echo "selected";}?>><?php echo $obj1->cat_nombre;?></option>
