...
if(isset($_POST['submit']))
{
	...
	nombre_competencia='$nombrecompetencia' where id='$id'";
...
{//comienza 4
	...
	<div class="form-group">
							...
							<input type="number" id="descuento" name="descuento" class="form-control" min="0" value="<?php echo (string)$row->prod_porcdescuento*100;?>" step="0.001"></label>
...
<div class="row">
	...
	<button type="button" class="btn btn-primary" 
                             data-toggle="modal" data-target="#ingredientesModal" 
                                data-codigo="<?php echo $id; ?>" 
                                data-nombre="<?php echo $nombreProducto; ?>"
                                >Agregar</button>
...
while($row = pg_fetch_object($consultar)){?>
	...
	<?php include('include/setting.php');?>
		...
		<script>new DataTable('#componentes');</script>	
