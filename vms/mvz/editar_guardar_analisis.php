...
if (isset($datosRecibidos['analisis']) && isset($datosRecibidos['histoId'])) {

    // Acceder a los datos de la tabla
    $datosAnalisis = $datosRecibidos['analisis'];
    $historialId = $datosRecibidos['histoId'];
    
    $borrarAnalisisExistente=pg_query($db,"DELETE FROM analisis_mascota where historial_id='$historialId'; ");
