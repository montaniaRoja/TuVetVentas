      ...
      success: function(resp){
        ...
        if (res && res.hasOwnProperty('mensaje') && res.mensaje === 'ok') {
          ...
          array_monitoreos.forEach(i => {
            ...
            table.row.add([conteo,i.sucursal_nombre, i.monitoreo_codbarra,i.prod_nombre,i.empresa_nombre,i.empresa_direccion, i.monitoreo_precio,i.monitoreo_usuario_crea, i.monitoreo_ultima_actualizacion, boton]).draw(false);
          });
          $('#sucursal').val('');
          $('#producto').val('');
          $('#empresa').val('');
    ...
    success: function(resp){
      ...
      if (res && res.hasOwnProperty('mensaje') && res.mensaje === 'ok') {
        ...
        array_registros.forEach(i => {
          table.row.add([i.sucursal_nombre, i.empresa_nombre, i.bitacora_precio,i.bitacora_usuario_crea, i.bitacora_fecha]).draw(false);
        });
        //$('#modalCrearMonitoreo').modal('hide');
      } else {
        alert(res.mensaje);
