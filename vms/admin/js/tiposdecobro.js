document.addEventListener("DOMContentLoaded", function() {
    ...
    selectElement.addEventListener("change", function() {
        if (this.value === "Efectivo") {
            ...
            var submitButton = document.getElementById("cobrar");
            var txtEfectivo = document.getElementById("efectivo");
...
function enviarDatos() {
    ...
    let facturaId = document.getElementById("idFacturaInput").value;
    let facturaNumero = document.getElementById("factura").value;
    let fecha = document.getElementById("fecha").value;
    let hora = document.getElementById("hora").value;
    let tipoPago = document.getElementById("tipodepago").value;
    let condicion = document.getElementById("condicionInput").value;
    let nombre = document.getElementById("nombreClienteInput02").value;
    let copiaefectivo = document.getElementById("copiaefectivo").value;
    let copiatarjeta = document.getElementById("copiatarjeta").value;
    let total02 = document.getElementById("total02Input").value;
    let autorizacion = document.getElementById("autorizacion").value;

    //console.log(facturaId, facturaNumero, fecha, hora, tipoPago, condicion, nombre);

    // Realizar la solicitud AJAX
    $.ajax({
        type: "POST",
        url: "procesarcobro.php",
        data: {
            facturaId: facturaId,
            ...
            condicion: condicion,
            nombre: nombre,
            copiaefectivo: copiaefectivo,
            copiatarjeta: copiatarjeta,
            total02: total02,
		...
		//	console.log(facturaId);
            $.ajax({
				...
				//	console.log("factura no se imprimio");
