				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Reporte Traslados</h1>
								</div>
									<ol class="breadcrumb">
										<li>
											...
											<div class="panel panel-white">
												...
												<div class="panel-body">
													...
													<form role="form" method="post" >
														...
														<a type="buttom" id="buscar" name="buscar" class="btn btn-o btn-primary" onClick="buscarTraslados()">
															Procesar
														</a>
													</form>
												</div>
