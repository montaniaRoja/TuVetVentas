...
class entrada{
    ...
    public function guardarEntrada($conexion) {
        
        $query = "INSERT INTO entradas (fecha, sucursal_id, codbarra, cantidad, detalle, usuario_procesa, usuario_autoriza, estado)
        ...
        if ($result) {
            ...
            echo "Error al guardar la entrada: " . pg_last_error($db);
        }
...
if(isset($_POST['submit'])){
    ...
    $estado="Pendiente";
    $usuarioA="";
    $entrada=new entrada($fecha_actual,$sucursal,$cod_barra,$cantidad,$detalle,$usuarioP,$usuarioA,$estado);
    
    if ($db) {
        //echo "conexion ok";
        $entrada->guardarEntrada($db);
        pg_close($db);
...
<html lang="en">
	<head>
		<title>Admin | Entradas de Productos</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Ajustes Entradas de Productos</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
						...
						<div class="container-fluid container-fullw bg-white">
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Entradas Productos</h5>
												</div>
							...
							<input type="number" id="cantidad" name="cantidad" class="form-control" autocomplete="off" min="0" value="0"></label>
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Entradas <span class="text-bold">Productos</span></h5>
									...
									<table id="example" class="display" style="width:100%">
										...
										<tbody>
<?php
$sql=pg_query($db,"select e.id, e.fecha, e.sucursal_id,s.sucursal_nombre, e.codbarra, p.prod_nombre, e.cantidad, e.detalle, e.usuario_procesa, e.estado
from entradas e join productos p on e.codbarra=p.prod_codbarra
join sucursales s on e.sucursal_id=s.id where e.estado='Pendiente';");
$cnt=1;
...
?>
											...
											<tr>
												...
												<td><?php echo $row->usuario_procesa;?></td>
												<td><?php echo $row->estado;?></td>
												<td>
												
												<div class="visible-md visible-lg hidden-sm hidden-xs">
                                                    <form id="confirmForm" action="procesarentrada.php" method="POST" onsubmit="return confirmAction()">
                                                        <input type="hidden" id="esteId" name="id" value="<?php echo $row->id; ?>">
                                                        ...
                                                        <button type="submit" name="autorizar" class="btn btn-transparent btn-xs" data-toggle="tooltip" data-placement="top" title="Autorizar">
                                                            Autorizar
                                                        </button>
                                                        <button type="submit" name="borrar" class="btn btn-transparent btn-xs" data-toggle="tooltip" data-placement="top" title="Borrar">
                                                            Borrar
                                                        </button>
...
<script>
    function confirmAction() {
    	var confirmed = confirm("¿proceder con la accion?");
        return confirmed;
    }
</script>
	</body>
