...
if (isset($_POST['submit'])) {
    ...
    $sucursal=$_POST['sucursal'];
        ...
        if ($result) {
            ...
            $detalledeventas = pg_query($db, "SELECT h.id_sucursal, s.sucursal_nombre, d.cod_barra, p.prod_nombre, c.cat_nombre, sum(d.cantidad) as cantidad,
    ...
    AND d.validado_sn=1
    GROUP BY d.cod_barra, p.prod_preciopublico, h.id_sucursal, s.sucursal_nombre, p.prod_nombre,c.cat_nombre
    ORDER BY d.cod_barra;");
            ...
            echo '<table border="1">';
            echo '<tr>';
            echo '<th colspan="11">Reporte Detalle de Ventas</th>';
            echo '</tr>';
            echo '<tr>
    <th>idSucursal</th>
