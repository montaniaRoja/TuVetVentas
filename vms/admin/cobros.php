 ...
 <input type="hidden" name="nombreCliente02" id="nombreClienteInput02" class="form-control wd-450 text-right">
  ...
  <div class="form-group">
   <label for="efectivo">Efectivo:</label>
    ...
    <input type="hidden" name="copiaefectivo" id="copiaefectivo" placeholder="" class="form-control wd-450 text-right"  step="0.01" min="0" value="0">
  </div>
  
  <div class="form-group">
   <label for="tarjeta">Tarjeta :</label>
    <input type="text" name="tarjeta" disabled class="form-control wd-450 text-right"  step="0.01" min="0" value="0">
    <input type="hidden" name="copiatarjeta" id="copiatarjeta" placeholder="" class="form-control wd-450 text-right"  step="0.01" min="0" value="0">
  </div>
 ...
 <div class="form-group">
  ...
  <div class="form-group">
   <label for="autorizacion">Numero de Autorizacion:</label>
    <input name="autorizacion" id="autorizacion" placeholder="" class="form-control wd-450 text-right">
  </div>
...
<div class="modal-footer">
 ...
 <button type="button" name="cobrar" id="cobrar" class="btn btn-primary" disabled onclick="enviarDatos()">Procesar cobro</button>
</div>
</form>
