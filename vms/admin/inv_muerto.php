						...
						<div class="row">
							<div class="col-md-12">
								...
								<table id="example" class="display" style="width:100%">
									...
									<tbody>
										...
										if ($resultado !== false) { // Verifica si $resultado es un objeto válido
											while ($row = pg_fetch_object($resultado)) {
												$sumatotal += ($row->existencia * $row->prod_costopromedio);
										?>
												<tr>
													<td><?php echo htmlspecialchars($row->sucursal_nombre); ?></td>
													<td><?php echo htmlspecialchars($row->codbarra); ?></td>
													<td><?php echo htmlspecialchars($row->prod_nombre); ?></td>
													<td><?php echo htmlspecialchars($row->existencia); ?></td>
													<td><?php echo htmlspecialchars($row->prod_costopromedio); ?></td>
													<td><?php echo htmlspecialchars($row->costototal); ?></td>
													<td><?php echo htmlspecialchars($row->ultimoingreso); ?></td>
													<td><?php echo htmlspecialchars($row->ultimaventa); ?></td>
													<td>
														<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-codigo="<?php echo htmlspecialchars($row->codbarra); ?>" data-sucursal="<?php echo htmlspecialchars($row->id_sucursal); ?>">Ver detalle</button>
													</td>
												</tr>
										<?php
												$cnt++;
									...
									<tfoot>
										<tr>
											<th scope="row" colspan="5">Totales</th>
											<td style="font-size: 20px; font-weight: bold;"><?php echo "$ " . htmlspecialchars($sumatotal); ?></td>
