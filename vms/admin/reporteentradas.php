...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Reporte Entradas</h1>
</div>
<ol class="breadcrumb">
<li>
<span></span>
...
<h5 class="over-title margin-bottom-15"><span class="text-bold">Reporte Entradas</span></h5>
...
<button type="button" onclick="seleccionarTodas()">Seleccionar Todas</button>
 ...
 <div class="row">
    ...
    function setFormAction() {
        ...
        if (selectedOption == 1) {
    document.forms['marcas'].action = 'entradas_excel.php';
