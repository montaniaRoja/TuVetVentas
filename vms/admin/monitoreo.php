								...
								<div class="col-md-12">
									...
									<table class="table table-hover" id="tabla_monitoreo">
										...
										<tbody id="tbody_monitoreo">
											<?php
											$sql=pg_query($db,"
											SELECT m.monitoreo_id, m.monitoreo_sucursal_id,
                                            s.sucursal_nombre,
										...
										<div class="modal-body">
											...
											<input type="hidden" name="id_monitoreo" id="id_monitoreo">
                                                <div class="form-group">
                                                    ...
                                                    <select id="sucursal" name="sucursal" class="form-control" style="width: 100%" data-live-search="true">
														<option value=""></option>
														<?php 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="producto" id="producto" class="form-control" style="width: 100%" data-live-search="true" onchange="buscarprecio()">
