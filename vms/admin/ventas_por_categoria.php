                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-codigo="<?php echo $row->catid; ?>" data-sucursal="<?php echo $row->sucursalid; ?>" 
                                                    data-inicial="<?php echo $fechaInicial; ?>" 
                                                    data-final="<?php echo $fechaFinal; ?>">Ver detalle</button>
                                                </td>
                                            </tr>
                                        <?php
                                            $cnt = $cnt + 1;
