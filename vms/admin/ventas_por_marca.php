...
<body>
                                            ...
                                            <div class="panel-heading">
                                                ...
                                                <form role="form" name="marcas" method="post" action="" onsubmit="return setFormAction();">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="proveedor[]" id="proveedor" multiple placeholder="Select a supplier...">
                                                            <?php
                                                            ...
                                                            while ($obj1 = pg_fetch_object($consulta)) {   ?>
                                                                ...
                                                                <option value="<?php echo $obj1->id ?>"><?php echo $obj1->prov_nombre; ?></option>

                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                    <button type="button" onclick="seleccionarTodas()">Seleccionar Todos</button>
                                                    <p id="mensaje" style="color: green; font-weight: bold; display: none;">Todos los proveedores han sido seleccionados.</p>
    ...
    <<div class="modal fade bd-example-modal-lg" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
        ...
        <script src="./js/ventaspormarca.js"></script>
        <script>
        ...
        <script>
            ...
            const tomSelectInstance = new TomSelect("#proveedor", {
                maxItems: 60
            });
*/
            ...
            function seleccionarTodas() {
                ...
                // Seleccionar todas las opciones en el <select> subyacente
                ...
                // Disparar el evento 'change' para que Tom Select actualice su estado
