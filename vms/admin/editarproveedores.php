...
if(isset($_POST['submit']))
{
    ...
    $query=("update proveedores set prov_nombrecheque='$cheque', prov_ldireccion1='$direccion1',prov_ldireccion2='$direccion2', prov_telefono='$telefono', prov_correo='$correo', prov_nombrecontacto='$contacto', modificada_por='$_SESSION[login]', fecha_modificacion='$fecha_actual' where id='$id'");
