...
?>
											...
											<tr>
												...
												<div class="visible-md visible-lg hidden-sm hidden-xs">
                                                    <form id="confirmForm" action="procesarsalida.php" method="POST" onsubmit="return confirmAction()">
                                                        ...
                                                        <button type="submit" name="autorizar" class="btn btn-transparent btn-xs" data-toggle="tooltip" data-placement="top" title="Edit">
                                                            Autorizar
                                                        </button>
