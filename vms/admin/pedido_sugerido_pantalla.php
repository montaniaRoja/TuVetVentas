...
echo '<th>Producto</th>';
echo '<th>Marca</th>';
echo '<th>Existencia bodega</th>';
echo '<th>Venta 30 dias</th>';
echo '<th>Existencia</th>';
echo '<th>Punto Reorden</th>';
echo '<th>Venta maxima</th>';
echo '<th>Venta Segunda</th>';
echo '<th>Venta Tercera</th>';
echo '<th>Sugerencia Pedido</th>';
echo '<th>Pedido a Bodega</th>';
echo '</tr>';
