...
<html lang="en">
	<head>
		<title>Admin | Reporte Visitas Nuevos Clientes</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Reporte Visitas Nuevos Clientes</h1>
								</div>
									<ol class="breadcrumb">
										<li>
										...
										<li class="active">
											<span>Reporte Visitas Nuevos Clientes</span>
										</li>
									</ol>
							</div>
						</section>
												...
												<div class="panel-body">
													...
													<form role="form" method="post" >
														...
														<div class="form-group">
															...
															<select id="sucursal" name="sucursal" class="form-control" data-live-search="true" multiple>
																<?php 
																...
																while($obj1=pg_fetch_object($consulta1)){
																	...
																	?>
																	<option value="<?php echo $obj1->id ?>"<?php if($obj1->sucursal_nombre=='Seleccione sucursal'){echo "selected";}?>><?php echo $obj1->sucursal_nombre;?></option>
																<?php  }
														...
														<a type="buttom" id="buscar" name="buscar" class="btn btn-o btn-primary" onClick="buscarVisitasNuevosClientes()">
															Procesar
														</a>
													</form>
												</div>
