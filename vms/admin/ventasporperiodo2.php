...
<form role="form" name="periodo" method="post" action="" onsubmit="return setFormAction();">
                    ...
                    while ($row = pg_fetch_object($detalledeventas)) {
                        ...
                        <tr>
                           ...
                           <div class="visible-md visible-lg hidden-sm hidden-xs">
                                                    <form id="miniform" role="form" name="marcas" method="post" >
                                                        
                                                        <input type="text" name="cod" value="<?php echo $row->cod_barra; ?>">
                                                        <input type="text" name="fechaI" value="<?php echo $fechaInicial; ?>">
                                                        <input type="text" name="fechaF" value="<?php echo $fechaFinal; ?>">
                                                        <input type="text" name="codsuc" value="<?php echo $row->id_sucursal; ?>">
                                                        <button type="submit" name="btndetalle" onclick="$('#detalleModal').modal('show');">
                                                            Ver Detalle
                                                        </button>
...
<div class="modal fade" id="detalleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <input type="text" id="txtcodigo" readonly>
 ...
 <?php  if (isset($_POST['btndetalle'])) {
    ...
    $codigo = $_POST['cod'];
    $fechaInicial = date('Y-m-d', strtotime($_POST['fechaI']));
    $fechaFinal = date('Y-m-d', strtotime($_POST['fechaF']));
    $sucursal = $_POST['codsuc'];
...
?>
    ...
    <tbody id="detalleModalTableBody">
